...
@section('contentAdmin')
    ...
    <div class="section-update-vehicle">
        {{-- <div class="row header-update-vehicle">
            <div class="btn-navigate-main-vehicle">
                <i class="fa-solid fa-circle-left"></i>
                <a href="/vehicle/all-vehicle">BACK</a>
            </div>
            <div class="name-vehicle">
                Vehicle {{$dataVehicle->vehicle_num}}
            </div>
            <div class="btn-update-vehicle ">
                UPDATE
            </div>
        </div> --}}
        <div class="card-title" style="display: flex;justify-content: space-between">
            ...
            <div class="col-sm-5">
                <div data-value = "{{$dataVehicle->id}}"class="btn-update-vehicle ">
                    UPDATE
                </div>
            </div>
        </div>
        <div class="body-update-vehicle ">
            <div class="form-update-vehicle">
                <div class="section-info-base">
                        <div class="part-input">
                            ...
                            <div class="form-ipt-field form-ipt-text">
                                <input id="ipt_vehicle_number" class="ipt-update-field ipt-url-img" value="{{$dataVehicle->vehicle_num}}" type="text">
                            </div>
                        </div>
                        <div class="part-input">
                            <div class="label-ipt-field label-ipt-media">
                            ...
                            <div class="form-ipt-field form-ipt-select">
                                <div class="ipt-update-field select-field">
                                    <div id="ipt_group_id" class="value-select-field" data-value="{{$dataVehicle->company_id}}">
                                        {{$dataVehicle->dataGroupCompany->dataParent->company_group}}-{{$dataVehicle->dataGroupCompany->company_group}}
                                    </div>
                        ...
                        <div class="form-ipt-field form-ipt-text">
                            <input id="ipt_tablet_id" class="ipt-update-field ipt-url-img" value="{{$dataVehicle->tablet_id}}"type="text">
                        </div>
                        </div>
                        <div class="part-input">
                        <div class="label-ipt-field label-ipt-media">
                        ...
                        <div class="form-ipt-field form-ipt-text">
                            <input id="ipt_number_phone" class="ipt-update-field ipt-url-img" value="{{$dataVehicle->sim_number}}"type="text">
                        </div>
                        </div>
                        <div class="part-input">
                        <div class="label-ipt-field label-ipt-media">
                        ...
                        <div class="form-ipt-field form-ipt-text">
                            <input id="ipt_app_id" class="ipt-update-field ipt-url-img" value="{{$dataVehicle->app_id}}"type="text">
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        $('.btn_update_vehicle').click(function() {
            ...
            if(vehical_num == '' || id_company == 0) {
                ...
                $.ajax({
                    url: '{{URL::to("/vehicle/update-new-vehicle")}}',
                    method: 'post',
                    data: form,
                    contentType: false,
                    processData: false,
