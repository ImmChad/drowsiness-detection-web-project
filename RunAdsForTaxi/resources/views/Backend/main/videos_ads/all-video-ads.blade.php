            ...
            <div class="card-body">
                ...
                <div  class="row" style="margin-top:20px; height: 500px;">
                    <div class="col-md-4" style=" height: 500px;  display: flex; justify-content: flex-start; align-items: flex-start; flex-direction: column;">
                        ...
                        <div class="form-group row" style="width: 100%">
                            <div class="form-group col-md-12">
                                ...
                                <div class="input-ads" style="display: flex;justify-content: space-between; padding-right: 0px; height: 40px;">
                                    <input type="text" class="text-name-group" style=" width: 100%; color: #0e5904; font-weight: 700; border: none; background: transparent; outline: none;"  type="text" id="video_path" placeholder="Enter link video ..." autocomplete="off" disabled>
                                    ...
                                    <button class="btn-name-group btn-upload-video" style=" width: 150px; font-size: 15px; font-weight: 700; border: 3px solid #0e5904; background: #0e5904; outline: none; border-radius: 17px; color: white; cursor: pointer;">
                                        Upload
                                    </button>
                                </div>
                            </div>
                        ...
                        <div class="form-group row" style="width: 100%">
                            <div class="form-group col-md-12">
                                <button class="btn-name-group btn-add-video" style=" width: 100%; height: 40px; font-size: 15px; font-weight: 700; border: 3px solid #0e5904; background: #0e5904; outline: none; border-radius: 17px; color: white; cursor: pointer;">
                                    Add
                                </button>
                            </div>
                        </div>
                                ...
                                <tbody class="scroll-table">
                                    @foreach($dataVideo as $subDataVideo)
                                        <tr class="row_data_news">
                                            ...
                                            <td >
                                                <span class="btn-coppy" style="font-size: 20px; color: #3c9c38; cursor: pointer;" video_path="{{ $subDataVideo->video_path }}">
